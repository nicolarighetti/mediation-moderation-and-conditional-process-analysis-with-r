...
$$\hat y = b_1x + b_2*(w=0) + b_3x*(w=0)$$ 
$$\hat y = b_1x + b_2*0 + b_3x*0$$ 
$$\hat y = b_1x$$ 
$$\hat y = 0.120*negemot$$
...
$$\hat y = (b_1x_1*0) + (b_2x_2*0) + b_3w + (b_4x_1w*0) + (b_5x_2w*0) + e$$ 
$$\hat y = b_3w$$ $$\hat y = -0.47w$$
