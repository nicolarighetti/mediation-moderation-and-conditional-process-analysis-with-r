...
DiagrammeR::grViz("digraph {
  ...
  rec0 [label = 'UNIT 3\b MEDIATION ANALYSIS']
...
```{r echo=FALSE}
knitr::include_graphics("img/simple_mediation_output_a.png")
```

```{r echo=FALSE}
knitr::include_graphics("img/simple_mediation_output_b.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("img/mediation_effectsize.png")
```
...
process(pmi_data, y = "reaction", x = "cond", m = c("import", "pmi"), 
        model = 4, total = 1, contrast = 1,
        seed = 10)
```

```{r echo=FALSE}
process(pmi_data, y = "reaction", x = "cond", m = c("import", "pmi"), 
        model = 4, total = 1, contrast = 1, effsize = 1,
        seed = 10)
```
...
```{r eval=FALSE}
process(pmi_data, y = "reaction", x = "cond", m = c("import", "pmi"), 
        model = 6, total = 1, contrast = 1, boot = 10000,
        seed = 031216)
```
