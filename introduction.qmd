...
For example, let's say that we have established a relationship between the use of violent video games and the frequency of off-line assaults. The next step may be to ask *how does this happen*, and use mediation analysis to analyze the potential mechanism by which violent video games impact offline aggressive behavior.

Next, we focus on **moderation analysis** and we learn how to fit, visualize, interpret, and evaluate moderation models using PROCESS in the R environment. Moderation analysis is used to answer questions of the **WHEN** variety, that is to say, to study the conditions or contingencies of an association.
